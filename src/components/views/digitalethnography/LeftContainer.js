  ...
  return (
    <div className="flex flex-col gap-4  w-full mb-4">
      <section className="flex flex-col gap-4 items-center bg-gray-200 p-6 rounded-lg">
        ...
        <h2 className="text-xl font-semibold">BANTU</h2>
      ...
      <section className="flex flex-col gap-4 bg-gray-200 p-6 rounded-lg">
        <h1 className="text-2xl font-semibold">Timeline Synosis</h1>
        <h2 className="text-xl font-semibold">3000 BCE</h2>
